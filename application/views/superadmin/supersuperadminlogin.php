            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-12 offset-sm-0">
                    <div class="login-form text-center">
                        ...
                        <?php echo form_open('supersuperadmin/loginvalidate'); ?>
						
                            <input placeholder="USERNAME" type="text" name="loginusername" value="<?php echo set_value('username'); ?>" autocomplete="off" required>
                            <?php echo form_error('loginusername', '<div class="text-danger">', '</div>'); ?>
                            <input placeholder="PASSWORD" type="Password" name="loginpassword" id="Password" class="Password" value="" autocomplete="off">
                            <?php echo form_error('loginpassword', '<div class="text-danger">', '</div>'); ?>
							...
							<span class="create-acc"><a href="<?php echo base_url('supersuperadmin/forgotpasswordindex'); ?>">Forgot Password <a/></span>
                        <?php echo form_close(); ?>
                    </div>
                </div>
            </div>
