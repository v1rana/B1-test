...
<?php
	...
	// echo $this->session->userdata('registrar_emailidd');
	// exit;
				...
				<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 mt-5">
					<div class="login-form text-center"> 
						...
						<?php echo form_open('admin/updatepassword'); ?>
							<input placeholder="USERNAME" type="email" name="loginusername" value="<?php echo $this->session->userdata('registrar_emailidd'); ?>" readonly>                       
